...
mvn -Dokta.oauth2.issuer=https://dev-35030395.okta.com/oauth2/default \
    -Dokta.oauth2.clientId=0oa1ec2wh3xkWhHhN5d7 \
    -Dokta.oauth2.clientSecret=3nAypSZjbBU_HQIQRjxV0mRsitG68jmi8bkzXGjr
```
...
```bash
export OKTA_OAUTH2_ISSUER=https://dev-35030395.okta.com/oauth2/default
export OKTA_OAUTH2_CLIENT_ID=0oa1ec2wh3xkWhHhN5d7
export OKTA_OAUTH2_CLIENT_SECRET=3nAypSZjbBU_HQIQRjxV0mRsitG68jmi8bkzXGjr
```
